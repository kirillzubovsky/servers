...
- **[MD2Doc](https://md2doc.com/mcp)** - Convert markdown to Word (.docx) documents. Remote hosted server, no installation. To add to Claude Code, just use `claude mcp add --transport sse md2doc https://md2doc.com/mcp/sse`
